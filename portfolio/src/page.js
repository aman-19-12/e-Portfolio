  ...
  return (
    <section className="h-screen flex items-center justify-center bg-slate-800/50 pt-20" id="hero">
      <div className="text-center max-w-4xl px-6">
        <p className="text-cyan-400 text-lg font-medium mb-3">Hi, I'm</p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <p className="text-slate-300 text-lg leading-relaxed mb-6">
              I am a passionate software engineer with 5+ years of experience specializing in the modern JavaScript ecosystem. My focus is on creating beautiful, high-performance user experiences and robust, well-tested backend services. I thrive in environments that value clean code and innovative problem-solving.
            </p>
            <p className="text-slate-300 text-lg leading-relaxed">
              I believe that the best products are built at the intersection of powerful technology and elegant design. Currently obsessed with signals-based state management and edge computing.
            </p>
          </div>
...
const App = () => {
  ...
  const refs = { hearoRef, aboutRef, projectsRef, contactRef };
  ...
  useEffect(() => {
    document.title = "[Your Name] | Full Stack Developer Portfolio";
  }, []);
